...
(function (global, factory) {
    ...
    var defaultOptions = {
        ...
        credits: [
            ["https://github.com/tenriajeng", "Powered by pos mini"],
            Type.ARRAY,
        ],
    };
    ...
    var toNaturalFileSize = function toNaturalFileSize(bytes) {
        ...
        if (bytes < GB) {
            return (
                removeDecimalsWhenZero(bytes / MB, 1, decimalSeparator) + " MB"
            );
        }
    ...
    var create$4 = function create(_ref2) {
        ...
        if (instantUpload && allowRevert) {
            Buttons["RevertItemProcessing"].label =
        ...
        if (alignRemoveItemButton && allowRevert) {
            Buttons["RevertItemProcessing"].align =
