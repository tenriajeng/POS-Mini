            ...
            keyBinds: {
                ...
                "control space": function controlSpace() {
                    ...
                    if (this.widget.find(".timepicker").is(":visible")) {
                        this.widget
                            .find('.btn[data-action="togglePeriod"]')
                            .click();
                    }
        ...
        var DateTimePicker = /*#__PURE__*/ (function () {
            ...
            _proto._setValue = function _setValue(targetMoment, index) {
                ...
                if (this._options.stepping !== 1) {
                    targetMoment
                        .minutes(
                            Math.round(
                                targetMoment.minutes() / this._options.stepping
                ...
                if (this._isValid(targetMoment)) {
                    ...
                    if (
                        ...
                        outpValue = outpValue.replace(
                            new RegExp(
                                this._options.multidateSeparator + "\\s*$"
                            ),
                            ""
                        );
                    } else {
                        outpValue = this._dates[index].format(
                            this.actualFormat
                        );
                    }
            ...
            _proto._isEnabled = function _isEnabled(granularity) {
                ...
                switch (granularity) {
                    ...
                    case "d":
                        return (
                            this.actualFormat.toLowerCase().indexOf("d") !== -1
                        );

                    case "h":
                    case "H":
                        return (
                            this.actualFormat.toLowerCase().indexOf("h") !== -1
                        );
                ...
                function _handlePromptTimeIfNeeded(e) {
                    if (this._options.promptTimeOnDateChange) {
                        if (!e.oldDate && this._options.useCurrent) {
                            ...
                            e.oldDate &&
                            e.date &&
                            (e.oldDate.format("YYYY-MM-DD") ===
                                e.date.format("YYYY-MM-DD") ||
                                (e.oldDate.format("YYYY-MM-DD") !==
                                    e.date.format("YYYY-MM-DD") &&
                                    e.oldDate.format("HH:mm:ss") !==
            ...
            _proto._showMode = function _showMode(dir) {
                ...
                this.widget
                    ...
                    .filter(
                        ".datepicker-" +
                            DatePickerModes[this.currentViewMode].CLASS_NAME
                    )
                    .show();
            };
            ...
            _proto._isInDisabledHours = function _isInDisabledHours(testDate) {
                return (
                    this._options.disabledHours[testDate.format("H")] === true
                );
            };

            _proto._isInEnabledHours = function _isInEnabledHours(testDate) {
                return (
                    this._options.enabledHours[testDate.format("H")] === true
                );
            };
            ...
            _proto._parseInputDate = function _parseInputDate(
                inputDate,
                _temp
            ) {
                var _ref = _temp === void 0 ? {} : _temp,
                    ...
                    isPickerShow =
                        _ref$isPickerShow === void 0
                            ? false
                            : _ref$isPickerShow;

                if (
                    this._options.parseInputDate === undefined ||
                    isPickerShow
                ) {
            ...
            _proto._indexGivenDates = function _indexGivenDates(
                givenDatesArray
            ) {
            ...
            _proto._indexGivenHours = function _indexGivenHours(
                givenHoursArray
            ) {
            ...
            _proto._initFormatting = function _initFormatting() {
                ...
                this.actualFormat = format.replace(
                    ...
                    function (formatInput) {
                        return (
                            (self.isInitFormatting &&
                            self._options.date === null
                                ? self.getMoment()
                                : self._dates[0]
                            )
                                .localeData()
            ...
            _proto._getLastPickedDate = function _getLastPickedDate() {
                var lastPickedDate =
                    this._dates[this._getLastPickedDateIndex()];
            ...
            _proto.readonly = function readonly(_readonly) {
                ...
                if (typeof _readonly !== "boolean") {
                    throw new TypeError(
                        "readonly() expects a boolean parameter"
                    );
                }
            ...
            _proto.options = function options(newOptions) {
                ...
                var self = this,
                    optionsKeys = Object.keys(this._options).sort(
                        optionsSortFn
                    );
            ...
            _proto.updateOnlyThroughDateOption =
                function updateOnlyThroughDateOption(
            ...
            _proto.dayViewHeaderFormat = function dayViewHeaderFormat(
                newFormat
            ) {
                if (arguments.length === 0) {
            ...
            _proto.daysOfWeekDisabled = function daysOfWeekDisabled(
                ...
                if (
                    typeof _daysOfWeekDisabled === "boolean" &&
                    !_daysOfWeekDisabled
                ) {
            ...
            _proto.allowInputToggle = function allowInputToggle(
                _allowInputToggle
            ) {
                if (arguments.length === 0) {
            ...
            _proto.datepickerInput = function datepickerInput(
                _datepickerInput
            ) {
                if (arguments.length === 0) {
    ...
    var TempusDominusBootstrap4 = (function ($) {
        ...
        var TempusDominusBootstrap4 = /*#__PURE__*/ (function (
            ...
            _proto2._init = function _init() {
                if (this._element.hasClass("input-group")) {
                    var datepickerButton =
                        this._element.find(".datepickerbutton");
                        ...
                        $("<tr>")
                            ...
                            .append(
                                $("<th>")
                                    ...
                                    .append(
                                        this._iconTag(this._options.icons.next)
                                    )
                            )
                    ),
                        ...
                        topRow.append(
                            $("<td>").append(
                                $("<a>")
                                    ...
                                    .append(
                                        this._iconTag(this._options.icons.up)
                                    )
                            )
                        );
                        middleRow.append(
                        ...
                        bottomRow.append(
                            $("<td>").append(
                                $("<a>")
                                    ...
                                    .append(
                                        this._iconTag(this._options.icons.down)
                                    )
                            )
                        );
                    }
                    ...
                    row.push(
                        $("<td>").append(
                            $("<a>")
                                ...
                                .append(
                                    this._iconTag(this._options.icons.today)
                                )
                        )
                    );
                }
                    ...
                    row.push(
                        $("<td>").append(
                            $("<a>")
                                ...
                                .append(
                                    this._iconTag(this._options.icons.clear)
                                )
                        )
                    );
                }
                    ...
                    row.push(
                        $("<td>").append(
                            $("<a>")
                                ...
                                .append(
                                    this._iconTag(this._options.icons.close)
                                )
                        )
                    );
                }
            ...
            _proto2._place = function _place(e) {
                ...
                if (vertical === "auto") {
                    ...
                    if (
                        ...
                        self.widget.height() + self._element.outerHeight() <
                            offset.top
                    ) {
                        vertical = "top";
                    } else {
                ...
                if (horizontal === "auto") {
                    if (
                        parent.width() <
                            offset.left + self.widget.outerWidth() / 2 &&
                        offset.left + self.widget.outerWidth() >
                            $(window).width()
                    ) {
                        horizontal = "right";
                    } else {
            ...
            _proto2._fillDow = function _fillDow() {
                ...
                while (
                    currentDate.isBefore(this._viewDate.clone().endOf("w"))
                ) {
                    row.append(
            ...
            _proto2._updateMonths = function _updateMonths() {
                ...
                months.each(function (index) {
                    if (
                        !self._isValid(self._viewDate.clone().month(index), "M")
                    ) {
            ...
            _proto2._updateYears = function _updateYears() {
                ...
                while (!startYear.isAfter(endYear, "y")) {
                    html +=
                        ...
                        (startYear.isSame(this._getLastPickedDate(), "y") &&
                        !this.unset
                            ? " active"
                            : "") +
                        (!this._isValid(startYear, "y") ? " disabled" : "") +
            ...
            _proto2._updateDecades = function _updateDecades() {
                var decadesView = this.widget.find(".datepicker-decades"),
                    ...
                    yearCaps = this._getStartEndYear(
                        100,
                        this._viewDate.year()
                    ),
            ...
            _proto2._doAction = function _doAction(e, action) {
                ...
                switch (action) {
                    case "next": {
                        var navFnc =
                            DateTimePicker.DatePickerModes[this.currentViewMode]
                                .NAV_FUNCTION;
                    ...
                    case "selectDecade": {
                        var _year =
                            parseInt($(e.target).data("selection"), 10) || 0;
                    ...
                    case "togglePeriod": {
                        this._setValue(
                            lastPicked
                                .clone()
                                .add(lastPicked.hours() >= 12 ? -12 : 12, "h"),
                            this._getLastPickedDateIndex()
                        );
                    ...
                    case "togglePicker":
                        {
                            ...
                            if (expanded && expanded.length) {
                                ...
                                if (this._useFeatherIcons()) {
                                    iconTest = $link.hasClass(
                                        this._options.icons.date
                                    );
                                } else {
                                    iconTest = $span.hasClass(
                                        this._options.icons.date
                                    );
                                }
                    ...
                    case "selectMinute":
                        this._setValue(
                            lastPicked
                                .clone()
                                .minutes(parseInt($(e.target).text(), 10)),
                            this._getLastPickedDateIndex()
                        );
                    ...
                    case "selectSecond":
                        this._setValue(
                            lastPicked
                                .clone()
                                .seconds(parseInt($(e.target).text(), 10)),
                            this._getLastPickedDateIndex()
                        );
            ...
            _proto2.show = function show() {
                ...
                if (
                    ...
                    if (typeof this._options.useCurrent === "string") {
                        currentMoment =
                            useCurrentGranularity[this._options.useCurrent](
                                currentMoment
                            );
                    }
            ...
            _proto2.toolbarPlacement = function toolbarPlacement(
                _toolbarPlacement
            ) {
                if (arguments.length === 0) {
            ...
            _proto2.widgetPositioning = function widgetPositioning(
                ...
                if (
                    {}.toString.call(_widgetPositioning) !== "[object Object]"
                ) {
                    throw new TypeError(
                ...
                if (_widgetPositioning.vertical) {
                    ...
                    if (
                        verticalModes.indexOf(_widgetPositioning.vertical) ===
                        -1
                    ) {
                        throw new TypeError(
